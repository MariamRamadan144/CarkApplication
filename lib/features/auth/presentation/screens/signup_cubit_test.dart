...
class SignUpCubitTest extends StatefulWidget {
  const SignUpCubitTest({super.key});

  @override
  State<SignUpCubitTest> createState() => _SignUpCubitTestState();
}

class _SignUpCubitTestState extends State<SignUpCubitTest> {
                        ...
                        Center(
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              //   //   ),
                              //   // );
                                authCubit.signup(_firstnameController.text, _lastnameController.text, _emailController.text, _phoneController.text, _passwordController.text);
                              // }
                            },
                            child: Text(
