abstract class AssetsManager{
  ...
  static const String _loginImages = "$_imagesPath/login";
  ...
  static const String hondaLogo = "$_homeImages/Honda.jpeg";
  static const String mercedesLogo = "$_homeImages/Mercedes Benz.jpeg";
  static const String nissanLogo = "$_homeImages/Nissan.png";
  static const String lexusLogo = "$_homeImages/Lexus.png";
  static const String mazdaLogo = "$_homeImages/Mazda.jpeg";
  static const String subaruLogo = "$_homeImages/Subaru.jpeg";
  static const String chevroletLogo = "$_homeImages/Chevrolet.png";
  static const String hyundaiLogo = "$_homeImages/Hyundai.png";
  static const String kaiLogo = "$_homeImages/Kia.png";
  static const String porscheLogo = "$_homeImages/Porsche.jpeg";
  static const String renaultLogo = "$_homeImages/Renault.png";
